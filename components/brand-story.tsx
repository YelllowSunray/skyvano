...
export function BrandStory() {
  return (
    <section className="grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center bg-ivory px-5 py-12 sm:px-8 sm:py-16 md:px-16">
        <p className="text-[11px] uppercase tracking-[0.28em] text-gold">
          The house
        </p>
        <h2 className="mt-3 max-w-md font-serif text-3xl leading-tight sm:text-4xl md:text-5xl">
          Designed for those who stand out.
        </h2>
        <p className="mt-5 max-w-md text-base leading-7 text-muted sm:mt-6 sm:leading-8">
